...
export default function remarkPing({
  pingUsername,
  userURL,
  pingCharacter = "@",
  fencedStartSequence = "**",
  ...
  if (Compiler) {
    ...
    visitors.ping = (node) => {
      ...
      return (
        pingCharacter + fencedStartSequence + node.username + fencedEndSequence
      );
    };
  }
